            ...
            {categories.map((cat) => (
              ...
              >
                {cat.label}
                  ...
                  {/* Product Grid */}
                  {loading ? (
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-8 w-full">
                      {[...Array(8)].map((_, i) => (
                    ...
                    <div 
                      className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-8 w-full"
                    >
